...
-->
  ...
  <body>
    ...
    <!-- Header -->
    <?php $page='home'; include 'menu/navbar.php' ;?>
          ...
          <div class="item item-1">
            <div class="img-fill">
                <div class="text-content">
                  <h6>PORTAL PENGUMUMAN</h6>
                  <h4>BADAN PUSAT STATISTIK<br>KABUPATEN DOMPU</h4>
                  <p>Sebuah aplikasi untuk mempermudah pengumuman mitra</p>
                </div>
            </div>
          </div>
          <!-- // Item -->
    ...
    <div class="callback-form d-none">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
