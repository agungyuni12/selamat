  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>TES TAHAP II SELEKSI PETUGAS PENDATAAN LAPANGAN REGSOSEK 2022</h1>
            <h1>KABUPATEN DOMPU</h1>
                ...
                <?php
                  ...
                  <div class="row">
                    <div class="col-lg-12 alert alert-success">
                      <fieldset>
                      <h1 class="alert-heading">PENTING !!!</h1>
                      </fieldset>
                    </div>
                      <div>
                          <h3>Tes merupakan soal pilihan ganda yang dapat dikerjakan selama 60 menit, yang dilaksanakan pada rentang waktu berikut:</b></h3>
                          <h3>Hari/Tanggal: <b>Rabu, 14 September 2022</b>
                            <br>Waktu Pelaksanaan: <b>09.00 - 10.00</b>
                            <br>Link Tes: <a href="https://bpsdompu.com/selamat/pengumuman/404.php"><button class="alert alert-success">KLIK DISINI</button></a></h3>
                            <h3>Tes hanya dapat dilakukan <b>satu kali tanpa bisa mengulang</b>, jadi harap mengerjakan di tempat yg memiliki signal yg bagus.</h3>
                            <h3><br>Kejujuran dalam mengerjakan akan sangat kami hargai dan apa yg dikerjakan menjadi berkah. Dalam mengerjakan soal tidak diperkenankan kerjasama.</h3>
                            <h3><br>Diberi waktu <b>1 menit</b> untuk menekan tombol kirim sebelum soal tes otomatis tertutup</h3>
                    ...
                    ?>
                      <div class="row">
                        <div class="col-lg-12 alert alert-warning">
                          <fieldset>
                          <h2 class="alert-heading">Calon Mitra Atas Nama <?= $nama ;?> dinyatakan Lulus Sebagai Cadangan.</h2>
                          <h5>Silahkan Mengisikan Nomor HP yang dapat dihubungi (Nomor yg ada WA lebih utama).</h5>
                          </fieldset>
                        </div>
                          <div class="col-lg-12 mt-4">
                            <fieldset>
                              <input type="text" class="form-control" id="nomor2" name="nomor2" placeholder="Nomor HP Yang Dapat DiHubungi" required />
                            </fieldset>
                          </div>
                          <div class="col-lg-12">
                            <fieldset>
                              <button type="submit" class="border-button" name="kirim2">KIRIM</button>
                            </fieldset>
                          </div>
                      </div>
                    <?php
                    ...
                    ?>
                      <div class="row">
                        <div class="col-lg-12 alert alert-danger">
                          <fieldset>
                          <h2 class="alert-heading">Maaf <?= $nama ;?> Anda Tidak Lolos.</h2>
        ...
        $('#pengumuman').on('submit',function(e){
          ...
          if (nomor =="") {
              ...
              Swal.fire({
                icon:"error",
                title:"Gagal",
                text:"Ijazah tidak boleh kosong",
              })
          } else {
              $.ajax({
