<?php
  ...
  $nama_survey=$_GET['nama_survey'];
  $tahapan=$_GET['tahapan'];
?>
  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>TES TAHAP 2 SELEKSI PETUGAS PENDATAAN LAPANGAN REGSOSEK 2022</h1>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><em>PENGUMUMAN</em></h2>
              <span class="d-none">interdum nisl ac urna tempor mollis</span>
            </div>
          </div>
          <div class="col-md-12">
            <div class="contact-form">
              <form method="post" action="pengumuman2.php" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-lg-12 mb-4">
                    <fieldset>
                        <input type="hidden" name="kabupaten2" value="<?=$kabupaten ;?>" />
                        <input type="hidden" name="nama_survey2" value="<?=$nama_survey ;?>" />
                        <input type="hidden" name="tahapan2" value="<?=$tahapan ;?>" />
                        <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK" required>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                        <button type="submit" class="border-button">BUKA</button>
                    </fieldset>
                  </div>
                </div>
              </form>
