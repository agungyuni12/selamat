  ...
  <body>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>LIHAT PENGUMUMAN</h1>
            <span class="d-none">Dapat melihat pengumuman mitra</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2><em>FORM LIHAT PENGUMUMAN</em></h2>
              ...
              <hr>
                ...
                <?php
                    if (isset($_POST['preview'])) {
                      ...
                      $kabupaten2 = preg_replace("/[^a-zA-Z0-9]/", "", $kabupaten);
                      $sql = mysqli_query($conn,"SELECT DISTINCT nama_survei,tahapan FROM $kabupaten2");
                        ...
                        while($row = $sql->fetch_assoc()) {
                          ...
                          ?>
                                      <tr>
                                        ...
                                        <td><?= $nama_survei;?></td>
                                        <td><?= $tahapan;?></td>
                                        <td><button onclick="window.location.href='masukannik.php?kabupaten=<?=$kabupaten;?>&nama_survey=<?=$nama_survei;?>&tahapan=<?=$tahapan;?>'" class="border-button" name="lihat">LIHAT</button></td>
                                      </tr>
                          <?php
                        }
                      }
